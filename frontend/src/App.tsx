  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Store B2C Prefix Routes */}
        <Route path="/store" element={<Layout><Home /></Layout>} />
        <Route path="/store/products" element={<Layout><Products /></Layout>} />
        <Route path="/store/product/:slug" element={<Layout><ProductDetail /></Layout>} />
        <Route path="/store/cart" element={<Layout><Cart /></Layout>} />
        <Route path="/store/checkout" element={<Layout><Checkout /></Layout>} />
