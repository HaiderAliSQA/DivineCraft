            ...
            {steps.map((step, idx) => (
              <div key={idx} className="relative flex items-center gap-6">
                ...
                <div>
                  ...
                  <p className="font-dm text-sm text-white-2">Contact our WhatsApp hotline (+92 300 7709173) sharing your Order ID and attached proof images depicting the current state.</p>
                </div>
              </div>
            ))}
          </div>
