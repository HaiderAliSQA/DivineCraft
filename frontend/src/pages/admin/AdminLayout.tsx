...
const AdminLayout: React.FC = () => {
  ...
  const navLinks = [
    ...
    { label: 'Customer Orders', path: '/admin/orders', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01' },
  ];
      ...
      >
        ...
        <div className="h-20 flex items-center justify-between border-b border-navy-light px-6 shrink-0 bg-navy-mid">
          <Link to="/admin/dashboard" className="flex flex-col">
            <span className="font-heading text-white text-xl font-black tracking-wider">
              DIVENECRAFT
            </span>
