    ...
    <div className="animate-fadeIn font-dm pb-12 text-white">
      ...
      <div className="px-6 pt-6 grid grid-cols-1 xl:grid-cols-2 gap-6">
        ...
        <div className="space-y-6">
          ...
          {/* Customer Details */}
          <div className="bg-navy-mid border border-navy-light rounded-xl p-6 shadow-xs">
            <h3 className="text-white font-bold uppercase tracking-widest text-[11px] mb-4">Customer Details</h3>
            <div className="space-y-3 text-[13px]">
              {[
                { label: 'Shipping Address', value: shopName },
                { label: 'Customer Name', value: ownerName },
        ...
        <div className="space-y-6">
          ...
          {/* Payment Summary */}
          <div className="bg-navy-mid border border-navy-light rounded-xl p-6 shadow-xs">
            <h3 className="text-white font-bold uppercase tracking-widest text-[11px] mb-5">Payment Summary</h3>
            <div className="space-y-3.5 text-[14px] mb-5">
              ...
              <div className="flex justify-between border-t border-navy-light pt-3.5">
                <span className="text-white font-bold uppercase tracking-widest text-[11px]">Remaining Balance</span>
                <span className={`font-bold text-lg ${totalDue > 0 ? 'text-red-400' : 'text-emerald-400'}`}>
                  {totalDue > 0 ? `PKR ${totalDue.toLocaleString()}` : '✅ FULLY PAID'}
                </span>
              </div>
            </div>
          ...
          <div className="bg-navy-mid border border-navy-light rounded-xl overflow-hidden shadow-xs">
            <div className="px-6 py-4 border-b border-navy-light">
              <h3 className="text-white font-bold uppercase tracking-widest text-[11px]">Payment Log</h3>
            </div>
            ...
            {payments.length === 0 ? (
              <div className="p-12 text-center text-gray-500">
                ...
                <p className="text-[11px] mt-1">Record payments above to update the order balance.</p>
              </div>
            ) : (
              <>
                <div className="overflow-x-auto">
